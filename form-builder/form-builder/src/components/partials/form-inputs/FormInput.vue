...
<script>
import FormInputText from '@/components/partials/forms/inputs/FormInputText.vue';
import FormInputMaskedText from '@/components/partials/forms/inputs/FormInputMaskedText.vue';

/*
import FormInputPhone from '@/components/partials/forms/inputs/FormInputPhone.vue';
import FormInputEmail from '@/components/partials/forms/inputs/FormInputEmail.vue';
import FormInputUrl from '@/components/partials/forms/inputs/FormInputUrl.vue';
import FormInputSocial from '@/components/partials/forms/inputs/FormInputSocial.vue';
import FormInputZip from '@/components/partials/forms/inputs/FormInputZip.vue';
*/
