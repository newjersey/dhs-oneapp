...
| Stored Procedures                          | Migrated | Priority |
| :----------------------------------------- | :------: | -------: |
...
| OA_PKG_GEN.SP_AUTHENTICATE_APP_USER        |    x     |          |
| OA_PKG_GEN.SP_GET_HINT                     |          |          |
| OA_PKG_GEN.SP_GET_USER_ID                  |          |          |
| OA_PKG_GEN.SP_INSERT_APP_USER              |    x     |          |
| OA_PKG_GEN.SP_INSERT_BROWSER_DETAILS       |          |          |
| OA_PKG_GEN.SP_INSERT_STATISTICS            |          |          |
| OA_PKG_GEN.SP_INSERT_TEMP_USER             |          |          |
...
| OA_PKG_TOOLS.SP_UPDATE_STATISTICS          |          |          |
