                ...
                fields: [
                    {
                        ...
                        lead:
                            "It should take about 15 minutes to complete this application. If you aren't sure how to answer any questions, please don't worry. Give the best answer you can, and we'll work with you to confirm the details later.",
                        required: true,
                ...
                fields: [
                    {
                        ...
                        lead:
                            'You’re allowed to submit an application with only your name and address. However, we strongly encourage you to continue working on the application. ',
                        required: true,
