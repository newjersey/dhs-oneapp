    ...
    computed: {
        rowClass(){
            ...
            if (this.gutter){
                ...
                switch(target){
                    case 'sm-': target = this.sizeMap['sm']; size = this.gutter.slice(3); break;
                    case 'md-': target = this.sizeMap['md']; size = this.gutter.slice(3); break;
                    case 'lg-': target = this.sizeMap['lg']; size = this.gutter.slice(3); break;
                    case 'xl-': target = this.sizeMap['xl']; size = this.gutter.slice(3); break;
                    default: target = ''
                }
